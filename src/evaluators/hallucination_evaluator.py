...
class HallucinationEvaluator:
            ...
            if metric_config.get("evaluation_method") == "model_based":
                ...
                try:
                    eval_response = self.evaluation_model.generate(
                        prompt=eval_prompt,
                        config={"system_prompt": "You are an expert evaluator assessing AI model responses for hallucinations."}
                    )
    ...
    def _create_evaluation_prompt(self, prompt: str, response: str,
        ...
        where {min(scale)} means high hallucination/fabrication and {max(scale)} means no hallucination/fabrication,
